...
namespace locstat_to_xml
{
    class Program
    {
        ...
        {   string path_c = @"e:\!serv\config.cfg";
            ...
            //считываем из конфига данные для составленифя отчета
            //DataTable dt_c = new DataTable("tab0");
            //DataColumn a0 = new DataColumn("путь", typeof(String));
            //DataColumn a1 = new DataColumn("номер интерфейса", typeof(String));
            //DataColumn a2 = new DataColumn("др.", typeof(String));
            //dt_c.Columns.AddRange(new DataColumn[] { a0, a1, a2 });
...
//            string[] tab0Values = null;
        ...
        static void move2path(string @name_old, string @path)
        {    //откуда копируем
            string Dir1 = @path;
            //куда копируем
